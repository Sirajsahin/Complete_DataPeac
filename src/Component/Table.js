        ...
        <table className='table-area'>
            <thead className='thead'>
                <tr>
                    ...
                    <th>Age<span className='sort'> <p className='sort-btn' onClick={()=>sortingforNumber("age")}><AiOutlineCaretUp/></p><p className='sort-btn2' onClick={()=>unsortingforNumber("age")}><AiOutlineCaretDown/></p></span> </th>
                    <th>Email<span className='sort'> <p className='sort-btn' onClick={()=>sorting("email")}><AiOutlineCaretUp/></p><p className='sort-btn2' onClick={()=>unsorting("email")}><AiOutlineCaretDown/></p></span> </th>
                    <th>Website<span className='sort'> <p className='sort-btn' onClick={()=>sorting("web")}><AiOutlineCaretUp/></p><p className='sort-btn2' onClick={()=>unsorting("web")}><AiOutlineCaretDown/></p></span> </th>
                </tr>
            </thead>
